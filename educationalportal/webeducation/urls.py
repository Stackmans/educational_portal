...
urlpatterns = [
                  ...
                  path('subject/<int:subject_id>/<int:course_id>', views.SubjectTeacherTasksView.as_view(),
                       name='subject_teacher_tasks'),
                  path('subject/<slug:subject_name>/task/<int:task_id>/', views.TaskSolvingView.as_view(),
                       name='task_solving'),
                  path('<slug:subject_name>/task/<int:task_id>/solutions/', views.SolutionsView.as_view(),
                       name='check_solutions'),
                  path('check_solution/<int:task_id>/<int:solution_id>/', views.CheckSolutionView.as_view(),
                       name='check_solution'),
                  path('give_grade/<int:student_id>/<int:subject_id>/<int:task_id>/', views.GiveGradeView.as_view(),
                       name='give_grade'),
                  ...
                  path('subject/<int:subject_id>/<int:course_id>/quizzes/', views.CourseQuizzesView.as_view(),
                       name='course_quizzes'),
                  path('quiz_results/<int:quiz_id>/', views.QuizResultsView.as_view(), name='quiz_results'),
                  path('check_student_answer/<int:student_id>/<int:quiz_id>/', views.CheckStudentAnswerView.as_view(),
